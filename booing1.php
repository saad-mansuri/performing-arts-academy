...
if(@$_GET["book_id"]){
    ...
    echo("<script>location.href='booking1.php'</script>");
}
...
$str4="     
                    <div class='flexslider'>
                                ...
                                <div class='thumb-image'> <img src='img/".$row4["scatimg"]."' height='300'width='300'
                ...
                <h5><span class='course_disc'>Course Name  : ".$row4["scatname"]."</span></h5>
                <h5><span class='course_disc'>Discription  : ".$row4["discription"]."</span></h5>
...
$result4=$cnn->query($str4);
$str4="<table class='table table-striped table-bordered table-hover dataTable no-footer' id='dataTables-example' role='grid' aria-describedby='dataTables-example_info'><tr><th>Delete</th><th>Course Name</th><th>Date</th><th>Day</th><th>Time</th><th>Duration</th><th>Price</th><th>Image</th>
<th>Book Now</th></tr> ";
while($row4=$result4->fetch_assoc())
{
    $str4.="<tr>
    <td><a href='subcatdetails.php?tid=".$row4['bid']."'>delete</a></td>
    <td>".$row4["scatname"]."</td>
    <td>".$row4["date"]."</td>
    <td>".$row4["day"]."</td><td>".$row4["time"]."</td><td>".$row4["duration"]."</td><td>".$row4["price"]."</td>
    <td><img src='img/".$row4["scatimg"]."' height='100' width='100'>"."</td><td><div class='occasion-cart'>
