...
<div align="center">
<a style="color:white" href="catinsert11.php">Add Course</a>
</div>
...
{
	$str.="<tr><td><a href='catupdate11.php?Id=".$row['catid']."'><i class='fa fa-pencil'></i></a></td>
	<td><a href='catdelete11.php?Id=".$row['catid']."'><i class='fa fa-times'></a></td>
